...
void ElectronID::CheckClusters() {
	...
	const auto& EcalEndcapNClusters = static_cast<const edm4eic::ClusterCollection&>(*(mEvent->get("EcalEndcapNClusters")));
	const auto& EcalBarrelScFiClusters = static_cast<const edm4eic::ClusterCollection&>(*(mEvent->get("EcalBarrelScFiClusters")));
	const auto& EcalEndcapPClusters = static_cast<const edm4eic::ClusterCollection&>(*(mEvent->get("EcalEndcapPClusters")));
...
double ElectronID::GetClusterCone(const edm4eic::ReconstructedParticle& rcp, double frac)
{
	const edm4eic::Cluster* lead_cluster = nullptr;
