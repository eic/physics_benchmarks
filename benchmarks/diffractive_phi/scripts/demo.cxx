...
void demo(const char* fname = "rec_dvcs.root"){
  ...
  fmt::print(fmt::emphasis::bold | fg(fmt::color::forest_green), "Running diffractive_phi analysis...\n");
  ...
  auto c = new TCanvas();
  h_Q2->DrawCopy();
  c->SaveAs("results/diffractive_phi/Q2.png");
  c->SaveAs("results/diffractive_phi/Q2.pdf");
  fmt::print("{} diffractive_phi events\n",*n_Q2);
  fmt::print("{} tracks per event\n",*n_tracks);

  c = new TCanvas();
  h_n_dummy->DrawCopy();
  c->SaveAs("results/diffractive_phi/n_dummy.png");
  //c->SaveAs("results/diffractive_phi/n_dummy.pdf");
