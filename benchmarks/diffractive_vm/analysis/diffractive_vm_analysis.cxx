...
int diffractive_vm_analysis(const std::string& config_name, const int vm_type=1, const int mc_type=0)
{
  ...
  */
  ...
  auto d1 = d.Define("Q2_elec", "InclusiveKinematicsElectron.Q2")
             ...
             .Define("p2", momenta_from_reconstruction_minus, {"ReconstructedParticles","MCParticles","ReconstructedChargedParticlesAssoc"})
             .Define("ptVMREC_daugPlus",getPt,{"p1"}).Define("etaVMREC_daugPlus",getEta,{"p1"})
             .Define("scatElec",findScatElec,{"ReconstructedParticles","MCParticles","EcalEndcapNClusters","ReconstructedChargedParticlesAssoc","EcalEndcapNClustersAssoc"}).Define("etaElec",getEta,{"scatElec"})
  ...
  */
  ...
  auto d3 = d.Define("Q2_elec", "InclusiveKinematicsElectron.Q2")
             ...
             .Define("p1", momenta_from_reconstruction_plus, {"ReconstructedParticles"})
             .Define("p2", momenta_from_reconstruction_minus, {"ReconstructedParticles","MCParticles","ReconstructedChargedParticlesAssoc"})
             .Define("scatElec",findScatElec,{"ReconstructedParticles","MCParticles","EcalEndcapNClusters","ReconstructedChargedParticlesAssoc","EcalEndcapNClustersAssoc"})
  ...
  auto d4 = d.Define("Q2_elec", "InclusiveKinematicsElectron.Q2")
             .Define("w_elec", "InclusiveKinematicsElectron.W")
             .Define("scatElec",findScatElec,{"ReconstructedParticles","MCParticles","EcalEndcapNClusters","ReconstructedChargedParticlesAssoc","EcalEndcapNClustersAssoc"}).Define("e_rec_pt",getPt,{"scatElec"})
