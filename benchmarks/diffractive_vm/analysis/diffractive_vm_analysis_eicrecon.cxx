...
int diffractive_vm_analysis_eicrecon(const std::string& config_name, const int vm_type=1, const int mc_type=0)
{
  ...
  */
  ...
  //event kinematics
  auto d0 = d.Define("Q2_sim", "InclusiveKinematics.Q2")
             .Define("Q2_rec", "InclusiveKinematics.Q2")
             .Define("Q2_res", combinatorial_diff_ratio, {"Q2_sim", "Q2_rec"})
             .Define("x_sim", "InclusiveKinematics.x")
             .Define("x_rec", "InclusiveKinematics.x")
  ...
  */
  ...
  auto d1 = d.Define("Q2_elec", "InclusiveKinematics.Q2")
             .Define("y_elec", "InclusiveKinematics.y")
             .Define("w_elec", "InclusiveKinematics.W")
  ...
  */
  ...
  auto d2 = d.Define("Q2_elec", "InclusiveKinematics.Q2")
             .Define("w_elec", "InclusiveKinematics.W")
  ...
  auto d3 = d.Define("Q2_elec", "InclusiveKinematics.Q2")
             .Define("w_elec", "InclusiveKinematics.W")
             .Define("p1", momenta_from_reconstruction_plus, {"ReconstructedParticles"})
             .Define("p2", momenta_from_reconstruction_minus, {"ReconstructedParticles"})
  ...
  auto d4 = d.Define("Q2_elec", "InclusiveKinematics.Q2")
             .Define("w_elec", "InclusiveKinematics.W")
  ...
  auto d5 = d.Define("Q2_elec", "InclusiveKinematics.Q2")
             .Define("w_elec", "InclusiveKinematics.W")
             .Define("p1", momenta_from_reconstruction_plus, {"ReconstructedParticles"})
             .Define("p2", momenta_from_reconstruction_minus, {"ReconstructedParticles"})
             .Define("scatElec",findScatElec,{"ReconstructedParticles","MCParticles"})
