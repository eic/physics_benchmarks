...
echo "Running the upsilon benchmarks"
...
source benchmarks/upsilon/env.sh
...
EOF
#cat ${CONFIG}
root -b -q "benchmarks/upsilon/analysis/upsilon_analysis.cxx+(\"${CONFIG}\")"
if [[ "$?" -ne "0" ]] ; then
  echo "ERROR running rec_upsilon_analysis script"
  exit 1
fi
...
## =============================================================================
## All done!
echo "upsilon benchmarks complete"
